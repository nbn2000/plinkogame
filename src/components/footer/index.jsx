...
const words = [
  ...
  "Play responsibly: Our website is an independent platform and is not directly affiliated with the sites we promote. Before participating in gambling, it is important to ensure that you comply with all applicable laws. Our content is provided for informational purposes only. By clicking on the links, you will be redirected to external websites, and we are not responsible for any outcomes or consequences.",
];
